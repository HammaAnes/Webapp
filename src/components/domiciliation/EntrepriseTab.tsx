...
import type { User, DemandeDomiciliation } from "../../types";
  ...
  if (!hasInfo) {
    return (
      <Card className="p-12 text-center">
        ...
        <Button onClick={openModal} className="bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 text-white">
    ...
    <div className="space-y-6">
      <Card className="p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <F label="Activité Principale" value={user.activitePrincipale || demande?.activitePrincipale || demande?.activiteExercee} icon={<Briefcase className="w-3.5 h-3.5" />} />
          {societe ? (
            <>
