...
export const userAdapter = {
  fromAPI: (apiData: ApiRecord): User => ({
    ...
    typeEntreprise: (apiData.type_entreprise || apiData.typeEntreprise) as string | undefined,
    nif: apiData.nif as string | undefined,
    nis: apiData.nis as string | undefined,
    registreCommerce: (apiData.registre_commerce || apiData.registreCommerce) as string | undefined,
    articleImposition: (apiData.article_imposition || apiData.articleImposition) as string | undefined,
    numeroAutoEntrepreneur: (apiData.numero_auto_entrepreneur || apiData.numeroAutoEntrepreneur) as string | undefined,
    raisonSociale: (apiData.raison_sociale || apiData.raisonSociale) as string | undefined,
    dateCreationEntreprise: (apiData.date_creation_entreprise || apiData.dateCreationEntreprise) as string | undefined,
    ...
    bannedUntil: (apiData.banned_until || apiData.bannedUntil) ? new Date(String(apiData.banned_until || apiData.bannedUntil)) : undefined,
    derniereConnexion: (apiData.derniere_connexion || apiData.derniereConnexion) ? new Date(String(apiData.derniere_connexion || apiData.derniereConnexion)) : undefined,
    dateCreation: (apiData.created_at || apiData.createdAt) ? new Date(String(apiData.created_at || apiData.createdAt)) : undefined,
    createdAt: (apiData.created_at || apiData.createdAt) as string | undefined,
    updatedAt: (apiData.updated_at || apiData.updatedAt) as string | undefined,
  }),
